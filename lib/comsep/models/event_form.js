...
//        list_my_event_forms: async function({ct, args, cb}) {
        list_my_event_forms: function({ct, args, cb}) {
...
//                    that.find(query, function(err, result) {
...
//            cb({user: ct.user, args});
        ...
        get_my_event_form: function({ct, args, cb}) {
            const {event_name, form_name, role_name,  workflow_id} = args.form_meta;
            const user_id = ct.user._id;
...
*/
        ...
        save_my_event_form_fields: function({ct, args, cb}) {
            const {event_name, form_name, role_name,  workflow_id} = args.form_meta;
            const user_id = ct.user._id;
            const form_key = {event_name, form_name, role_name,
                workflow_id: mongoose.Types.ObjectId(workflow_id),
...
*/
        ...
        drop_my_event_form: function({ct, args, cb}) {
            const {event_name, form_name, role_name,  workflow_id} = args.form_meta;
            const user_id = ct.user._id;
            const form_key = {event_name, form_name, role_name,
                workflow_id: mongoose.Types.ObjectId(workflow_id),
