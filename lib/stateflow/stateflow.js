...
/*
    define_role({ name, conditions, events, methods }={}) {
        const role_conditions = methodsToArray(conditions);
            ...
            Object.entries(events).forEach(([key, event]) => {
                ...
                if( event.transitions && Array.isArray(event.transitions) ) {
                    event.transitions.forEach( tr => {
                        tr.conditions = [ ...role_conditions, ...methodsToArray(tr.conditions) ];
